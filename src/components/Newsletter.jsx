...
const Newsletter = () => {
    return (
        ...
        >
            ...
            >Langganan untuk mendapatkan penawaran & diskon terbaru</motion.h1>
            <motion.div 
                initial={{ opacity: 0, y: 20 }}
                whileInView={{ opacity: 1, y: 0 }}
            ...
            >
                <input type="text" className="bg-transparent outline-none rounded-full px-4 h-full flex-1" placeholder="Masukkan alamat email Anda"/>
                <button 
                    type='submit' 
