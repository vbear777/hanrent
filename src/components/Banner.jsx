    ...
    return (
        ...
        >    
            <div className='text-white'>
                <h2 className='text-3xl font-medium'>Punya Mobil Sendiri?</h2>
                <p className='mt-2'>Daftarkan kendaraan Anda di HanRent dan raih pendapatan pasif dengan mudah.</p>
                <p className='max-w-130'>Kami menangani pembayaran aman, asuransi, dan verifikasi pengemudi untuk ketenangan Anda.</p>
