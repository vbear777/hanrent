                        ...
                        {cars.map((car, index) => (
                            <tr key={index} className='border-t border-borderColor'>
                                <td className='p-3 flex items-center gap-3'>
                                    <img src={car.image} alt="image cars" className='h-12 w-12 aspect-square rounded-md object-cover' />
                                ...
                                <td className='flex items-center p-3'>
                                    <img src={car.isAvailable ? assets.eye_close_icon : assets.eye_icon} alt="eye icon" className='cursor-pointer' />
