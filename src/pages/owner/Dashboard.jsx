            ...
            <div className='grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 my-8 max-w-3xl'>
                {dashboardCards.map((card, index) => (
                    <div key={index} className='flex gap-2 items-center justify-between p-4 rounded-md border border-borderColor'>
                        ...
                        <div className='flex items-center justify-center w-10 h-10 rounded-full bg-dark-ocean/10'>
                    ...
                    {data.recentBookings.map((booking, index) => (
                        <div key={index} className='mt-4 flex justify-between items-center'>
                            <div className='flex items-center gap-2'>
                                <div className='hidden md:flex items-center justify-center w-12 h-12 rounded-full bg-dark-ocean/10'>
                                    <img src={assets.listIconColored} alt="icon colored" className='h-5 w-5' />
                                </div>
                                <div>
